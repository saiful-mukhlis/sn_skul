...
<div id="bg">
  <?php echo CHtml::image(Yii::app()->baseUrl.'/img/study2.jpg')?>
</div>
...
?>
    ...
    <fieldset>
		<legend>Pendaftaran untuk Guru</legend>
		<hr />
...
<?php
Yii::app ()->clientScript->registerScript ( 'focususername', 'document.getElementById("DaftarGuru_nama").focus();', CClientScript::POS_END );
?> 
